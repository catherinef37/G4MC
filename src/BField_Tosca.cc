// ********************************************************************
// $Id: BField_Tosca.cc,v 3.0, 2011/1/19  G2P Exp $
// Implementation of the BField_Tosca class.
//
//////////////////////////////////////////////////////////////////////

#include "BField_Tosca.hh"
...
//#define BFIELD_TOSCA_DEBUG 0

#ifdef BFIELD_TOSCA_DEBUG
...
BField_Tosca* BField_Tosca::fInstance=0;
BField_Tosca* BField_Tosca::GetInstance()
{ 
	if(!fInstance)  new BField_Tosca();
	return fInstance; 
}
...
BField_Tosca::BField_Tosca(double pMomentum,const char *inifile,const char *mapfile)
{
#ifdef BFIELD_TOSCA_DEBUG
	if(BFIELD_TOSCA_DEBUG > Global_Debug_Level)
		SetGlobalDebugLevel("BField_Tosca::BField_Tosca()", (int)BFIELD_TOSCA_DEBUG);
#endif
	...
	*mRotF2L=mRotL2F->inverse(); 
	...
	if(pMomentum>0.0 && fabs(mCurrentRatio-pMomentum/mDefaultMomentum)>1.0E-04)
	{
		...
		cout<<"\n##BField_Tosca::BField_Tosca() Septum field current ratio is set to "<<mCurrentRatio<<endl;
...
/////////////////////////////////////////////////////////////////////
bool BField_Tosca::ReadIni(const char *filename)
{
	...
	pConfig->GetParameter("Tosca_UseUniformB",	mUseUniformB);
	pConfig->GetParameter("Tosca_UniformB_x",	mUniformB[0]);
	pConfig->GetParameter("Tosca_UniformB_y",	mUniformB[1]);
	pConfig->GetParameter("Tosca_UniformB_z",	mUniformB[2]);

	pConfig->GetParameter("Tosca_FieldUnit",	mFieldUnit);
	pConfig->GetParameter("Tosca_PosUnit",		mPosUnit);
	pConfig->GetParameter("Tosca_FirstDataLine",mFirstDataLine);
	pConfig->GetParameter("Tosca_NPara",		mNPara);
	pConfig->GetParameter("Tosca_FlipX",		mFlip[0]);
	pConfig->GetParameter("Tosca_FlipY",		mFlip[1]);
	pConfig->GetParameter("Tosca_FlipZ",		mFlip[2]);
	pConfig->GetParameter("Tosca_Direction",	mDirection);

	pConfig->GetParameter("Tosca_Xmin",			mXmin);
	pConfig->GetParameter("Tosca_Xmax",			mXmax);
	pConfig->GetParameter("Tosca_Ymin",			mYmin);
	pConfig->GetParameter("Tosca_Ymax",			mYmax);
	pConfig->GetParameter("Tosca_Zmin",			mZmin);
	pConfig->GetParameter("Tosca_Zmax",			mZmax);
	pConfig->GetParameter("Tosca_StepX",		mStepX);
	pConfig->GetParameter("Tosca_StepY",		mStepY);
	pConfig->GetParameter("Tosca_StepZ",		mStepZ);
	pConfig->GetParameter("Tosca_InterpolateOutOfRange", mInterpolateOutOfRange);

	pConfig->GetParameter("Tosca_OriginX",		mOrigin[0]);
	pConfig->GetParameter("Tosca_OriginY",		mOrigin[1]);
	pConfig->GetParameter("Tosca_OriginZ",		mOrigin[2]);
	pConfig->GetParameter("Tosca_RotAxis1",		mRotAxis[0]);
	pConfig->GetParameter("Tosca_RotAxis2",		mRotAxis[1]);
	pConfig->GetParameter("Tosca_RotAxis3",		mRotAxis[2]);
	pConfig->GetParameter("Tosca_RotAngle1",	mRotAngle[0]); mRotAngle[0]*=deg2rad;
	pConfig->GetParameter("Tosca_RotAngle2",	mRotAngle[1]); mRotAngle[1]*=deg2rad;
	pConfig->GetParameter("Tosca_RotAngle3",	mRotAngle[2]); mRotAngle[2]*=deg2rad;

	pConfig->GetParameter("Tosca_DefaultMomentum",mDefaultMomentum);
	pConfig->GetParameter("Tosca_CurrentRatio",	mCurrentRatio);	
	...
	while(!feof(ini))
	{
		...
		else if (strcmp(name,"Tosca_UniformB_x")==0)	mUniformB[0]=atof(value);
		else if (strcmp(name,"Tosca_UniformB_y")==0)	mUniformB[1]=atof(value);
		else if (strcmp(name,"Tosca_UniformB_z")==0)	mUniformB[2]=atof(value);

		else if (strcmp(name,"Tosca_FieldUnit")==0)		mFieldUnit=atof(value);
		else if (strcmp(name,"Tosca_PosUnit")==0)		mPosUnit=atof(value);
		else if (strcmp(name,"Tosca_FirstDataLine")==0) mFirstDataLine=atoi(value);
		else if (strcmp(name,"Tosca_NPara")==0)			mNPara=atoi(value);
		else if (strcmp(name,"Tosca_FlipX")==0)			mFlip[0]=atoi(value);
		else if (strcmp(name,"Tosca_FlipY")==0)			mFlip[1]=atoi(value);
		else if (strcmp(name,"Tosca_FlipZ")==0)			mFlip[2]=atoi(value);
		else if (strcmp(name,"Tosca_Direction")==0)		mDirection=atoi(value);

		else if (strcmp(name,"Tosca_Xmin")==0)			mXmin=atof(value);
		else if (strcmp(name,"Tosca_Xmax")==0)			mXmax=atof(value);
		else if (strcmp(name,"Tosca_Ymin")==0)			mYmin=atof(value);
		else if (strcmp(name,"Tosca_Ymax")==0)			mYmax=atof(value);
		else if (strcmp(name,"Tosca_Zmin")==0)			mZmin=atof(value);
		else if (strcmp(name,"Tosca_Zmax")==0)			mZmax=atof(value);
		else if (strcmp(name,"Tosca_StepX")==0)			mStepX=atof(value);
		else if (strcmp(name,"Tosca_StepY")==0)			mStepY=atof(value);
		else if (strcmp(name,"Tosca_StepZ")==0)			mStepZ=atof(value);
		else if (strcmp(name,"Tosca_InterpolateOutOfRange")==0) mInterpolateOutOfRange=atoi(value);

		else if (strcmp(name,"Tosca_OriginX")==0)		mOrigin[0]=atof(value);
		else if (strcmp(name,"Tosca_OriginY")==0)		mOrigin[1]=atof(value);
		else if (strcmp(name,"Tosca_OriginZ")==0)		mOrigin[2]=atof(value);
		else if (strcmp(name,"Tosca_RotAxis1")==0)		mRotAxis[0]=atoi(value);
		else if (strcmp(name,"Tosca_RotAxis2")==0)		mRotAxis[1]=atoi(value);
		else if (strcmp(name,"Tosca_RotAxis3")==0)		mRotAxis[2]=atoi(value);
		else if (strcmp(name,"Tosca_RotAngle1")==0)		mRotAngle[0]=atof(value)*deg2rad;
		else if (strcmp(name,"Tosca_RotAngle2")==0)		mRotAngle[1]=atof(value)*deg2rad;
		else if (strcmp(name,"Tosca_RotAngle3")==0)		mRotAngle[2]=atof(value)*deg2rad;

		else if (strcmp(name,"Tosca_DefaultMomentum")==0) mDefaultMomentum=atof(value);
		else if (strcmp(name,"Tosca_CurrentRatio")==0)	mCurrentRatio=atof(value);
		else continue;
	}
	fclose(ini);

	if(mNPara<6) mNPara=6; //mNPara should not less than 6 columns
	if(mFieldUnit<1.0E-08) 
	{
		cout<<"***Warning, the unit of this map is too small, please check the ini file ...... \n";
	}
	return true;
...
/////////////////////////////////////////////////////////////////////
bool BField_Tosca::ReadMap(const char *filename)
{
	char strLog[1024];
	sprintf(strLog,"BField_Tosca::ReadMap() is loading field map %s......\n",filename);
...
/////////////////////////////////////////////////////////////////////
bool BField_Tosca::Interpolation(double Pos[3],double B[3],int n)
{/*////////////////////////////////////////
...
void BField_Tosca::Rotate_Lab2Field(const double LabP[3],double FieldP[3])
{
...
void BField_Tosca::Transform_Lab2Field(const double LabP[3],double FieldP[3])
{
...
void BField_Tosca::Rotate_Field2Lab(const double FieldP[3],double LabP[3])
{
...
void BField_Tosca::Transform_Field2Lab(const double FieldP[3],double LabP[3])
{
...
////////////////////////////////////////////////////////////////////////////////////
void BField_Tosca::DoFlip(double pPos[], double flag[])
{
	/*
	##################################
...
/////////////////////////////////////////////////////////////////////
bool BField_Tosca::GetBField(double Pos[3],double B[3])
...
/////////////////////////////////////////////////////////////////////
bool BField_Tosca::GetBField(float fPos[3],float fB[3])
...
void BField_Tosca::CreateNtuple(const char *rootfile,int verbose,double xmin,double xmax,double xstep,
