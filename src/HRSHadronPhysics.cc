// ********************************************************************
//
// $Id: HRSHadronPhysics.cc,v 1.0, 2010/12/26   HRS Exp $
// --------------------------------------------------------------
//
...
#include "G4UserSpecialCuts.hh"  //will kill the track

// hadrons
#include "G4hIonisation.hh"

HRSHadronPhysics::HRSHadronPhysics(const G4String& name)
:  G4VPhysicsConstructor(name)
{
	
	G4cout<<"HRSHadronPhysics::HRSHadronPhysics() is constructing hadron model."<<G4endl;
}

HRSHadronPhysics::~HRSHadronPhysics()
{
}
...
void HRSHadronPhysics::ConstructParticle()
{
...
void HRSHadronPhysics::ConstructProcess()
{
	...
	//add step limiter, by jixie for Geant4.7.0 version and up
	pManager->AddProcess(new G4StepLimiter(),       -1, -1,3);
	//the old way to add user step limit
	//pManager->AddProcess(new G4UserSpecialCuts,   -1, -1,4);
	//pManager->AddDiscreteProcess(new G4StepLimiter);
	//pManager->AddDescreteProcess(new G4UserSpecialCuts);
	//add step limiter end
