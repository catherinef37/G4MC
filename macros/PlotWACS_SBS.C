...
bool ReadConfig()
{
  ...
  Long64_t nbytes = 0;
  double tmpAtg=0.0, tmpE=0.0, tmpZOff=0.0;
...
void PlotAcc_PhiTheta(const char* key="", int sdid=9, int trackid=0, const char* detector="SBS")
{
  ...
  h2N->Divide(hD);
  h2N->SetTitle(Form("%s Acc (\%) ; #theta (deg) ;#phi (deg) ",detector));
  h2N->Scale(100.0);
  h2N->Draw("colz text");
...
void PlotAcc_PTheta(const char* key="", int sdid=9, int trackid=0, const char* detector="SBS")
{
  ...
  h2N->Divide(hD);
  h2N->SetTitle("RTPC+ABS Acc (\%) ; #theta (deg) ; P (GeV/c) ");
  h2N->Scale(100.0);
  h2N->Draw("colz text");
...
void PlotPhoton(const char* inkey="")
{
  ...
  track0->Draw("fmod(Phi0*57.3+360,360.):Theta0*57.3>>hPTdeg_g(25,5,55,40,100,260)","","colz");
  ...
  c22->cd(2);
  gPad->SetRightMargin(0.15);
  track0->Draw("fmod(Phi0*57.3+360,360.):Theta0*57.3>>hPTdeg_g_det(25,5,55,40,100,260)","Pvb>0.2","colz");
  h2B = (TH2F*) gROOT->FindObject("hPTdeg_g_det");
  h2B->SetTitle(Form("%s Detected Photon ; #theta_{#gamma} (deg);#phi_{#gamma} (deg)",detector));
  ...
  h2C->Divide(h2A);
  h2C->Scale(100.0);
  h2C->SetTitle(Form("%s Photon Acc (\%) ; #theta_{#gamma} (deg);#phi_{#gamma} (deg)",detector));
  h2C->Draw("colz text");
...
void PlotElectron(const char* inkey="")
{
  ...
  c22->cd(1);
  gPad->SetRightMargin(0.15);
  track2->Draw("fmod(Phi0*57.3+360,360.):Theta0*57.3>>hPTdeg_e(25,5,55,40,100,260)","","colz");
  ...
  c22->cd(2);
  gPad->SetRightMargin(0.15);
  track2->Draw("fmod(Phi0*57.3+360,360.):Theta0*57.3>>hPTdeg_e_det(25,5,55,40,100,260)","Pvb>0.2","colz");
  h2B = (TH2F*) gROOT->FindObject("hPTdeg_e_det");
  h2B->SetTitle(Form("%s Detected Electron; #theta_{e} (deg);#phi_{e} (deg)",detector));
  ...
  h2C->Divide(h2A);
  h2C->Scale(100.0);
  h2C->SetTitle(Form("%s Electron Acc (\%) ; #theta_{e} (deg);#phi_{e} (deg)",detector));
  h2C->Draw("colz text");
...
void PlotProton(const char* inkey="")
{
  ...
  c22->cd(1);
  gPad->SetRightMargin(0.15);
  track1->Draw("Phi0*57.3:Theta0*57.3>>hPTdeg_p(25,10,35,50,-50,50)","","colz");
  h2A = (TH2F*) gROOT->FindObject("hPTdeg_p");
  h2A->SetTitle("Thrown Proton; #theta_{p} (deg);#phi_{p} (deg)");
 

  c22->cd(2);
  gPad->SetRightMargin(0.15);
  track1->Draw("Phi0*57.3:Theta0*57.3>>hPTdeg_p_det(25,10,35,50,-50,50)","Pvb>0.2","colz");
  h2B = (TH2F*) gROOT->FindObject("hPTdeg_p_det");
  h2B->SetTitle(Form("%s Detected Proton; #theta_{p} (deg);#phi_{p} (deg)",detector));
  ...
  h2C->Divide(h2A);
  h2C->Scale(100.0);
  h2C->SetTitle(Form("%s Proton Acc (\%) ; #theta_{p} (deg);#phi_{p} (deg)",detector));
  h2C->Draw("colz text");
...
void PlotRCS(const char* inkey="")
{
  ...
  const char *strCut[4]={"",
			 "track1.Pvb>0.01",
			 "track0.Pvb>0.01",
			 "track1.Pvb>0.01 && track1.Pvb>0.01"
  };
  ...
  if(SetupHMS)
    {
      h2C->GetXaxis()->SetRangeUser(10,20);
