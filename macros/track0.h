...
// Thu Nov 21 12:09:07 2013 by ROOT version 5.34/05
// from TTree track0/track 1
...
#ifdef track0_cxx
track0::track0(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     tree=(TTree*)gDirectory->Get("track0");
   }
   Init(tree);
}
...
Int_t track0::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t track0::LoadTree(Long64_t entry)
{
...
void track0::Show(Long64_t entry)
{
...
Int_t track0::Cut(Long64_t entry)
{
