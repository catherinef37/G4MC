...
void Phi0VsPvb(char *filename="")
{
	...
	h2Phi0P0->SetTitle(Form("#phi_{0} Vs P_{0} for HRS=%.1f^{o}, R_{field}=%.2f ; P_{0} (GeV); #phi_{0} (deg)",LHRSAngle*180./3.14159,HelmCurrentRatio));
	...
	pCan->cd();
	pCan->SaveAs(Form("PhiVsP_HRS%.1f_R%.2f.gif",LHRSAngle*180./3.14159,HelmCurrentRatio));	
 }
...
void Theta0VsPvb(char *filename="")
{
	...
	h2Theta0P0->SetTitle(Form("#theta_{0} Vs P_{0} for HRS=%.1f^{o}, R_{field}=%.2f , R_{field}=%.2f ; P_{0} (GeV); #theta_{0} (deg)",LHRSAngle*180./3.14159,HelmCurrentRatio));
   ...
   leg->Draw();
	...
	pCan->cd();
	pCan->SaveAs(Form("ThetaVsP_HRS%.1f_R%.2f.gif",LHRSAngle*180./3.14159,HelmCurrentRatio));	
 }
...
void Theta0VsPvb_newfcn(char *filename="")
{
	...
	h2Theta0P0->SetMarkerStyle(20);
	h2Theta0P0->SetMarkerColor(1);
	h2Theta0P0->SetTitle(Form("#theta_{0} Vs P_{0} for HRS=%.1f^{o}, R_{field}=%.2f ; P_{0} (GeV); #theta_{0} (deg)",LHRSAngle*180./3.14159,HelmCurrentRatio));
	h2Theta0P0->GetYaxis()->SetRangeUser(0,50);
	h2Theta0P0->Draw("prof");
	h2Theta0P0->Fit(f2,"R","", 0.3,3.3);
   ...
   leg->Draw();
	...
	pCan->cd();
	pCan->SaveAs(Form("ThetaVsP_HRS%.1f_newfcn_R%.2f.gif",LHRSAngle*180./3.14159,HelmCurrentRatio));	
 }
 ////////////////////////////////////////////////////////////////
...
void Theta0_trVsPvb(char *filename="")
{
	...
	h2Theta0_trP0->SetTitle(Form("#theta_{0}^{tr} Vs P_{0} for HRS=%.1f^{o}, R_{field}=%.2f ; P_{0} (GeV); #theta_{0}^{tr} (deg)",LHRSAngle*180./3.14159,HelmCurrentRatio));
	...
	pCan->cd();
	pCan->SaveAs(Form("Theta0_trVsP_HRS%.1f_R%.2f.gif",LHRSAngle*180./3.14159,HelmCurrentRatio));	
 }

 void ThetaVsPvb_BFieldRatio(const char *filename="")
 {
	 //plot them all
