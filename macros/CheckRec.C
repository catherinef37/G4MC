...
void DoPlotMapping(TCut theCut,int holeindex)
{
	...
	for(int i=0; i<4;i++)
	{
		...
		h12=DrawH1_RMS(hname,htitle,target,theCut,pHistoRange,"",4,4.0);
	...
	for(int i=0; i<4;i++)
	{
		...
		h1=DrawH1_RMS(hname,htitle,target,theCut,pHistoRange,"",4,4.0);
	...
	h1=DrawH1_RMS(hname,htitle,target,theCut,pHistoRange,"",1,4.0);
